<template>
    <div :class="{ 'opacity-50': todo.status === TodoStatus.Done }"
        ...
        <input v-if="isEdit" class="p-3 max-w-[300px]" placeholder="enter new Task" v-model="editValue" type="text">
        <span v-else class="font-bold text-stone-500">{{ todo.title }}</span>
